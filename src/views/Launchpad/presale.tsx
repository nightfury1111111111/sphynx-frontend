          ...
          <div style={{ marginTop: '24px', width: '100%', marginBottom: '24px' }}>
            ...
            >
              <p className="description">
                ...
                {chainId === ChainId.ETHEREUM ? 'UniSwap' : 'PancakeSwap'} (Min 0%, Max 100%, We recommend SphynxSwap)
              </p>
            ...
            <StepWrapper
              number="7"
              stepName={
                chainId === ChainId.ETHEREUM ? 'SphynxSwap/UniSwap Listing Rate' : 'SphynxSwap/PancakeSwap Listing Rate'
              }
              step={step}
              onClick={() => setStep(7)}
            >
              <p className="description">
                Enter the SphynxSwap/Pancake swap listing price: (If I buy 1 {nativeCurrency} worth on Swap how many
              ...
              <p className="description">
                *to verify your tier, please reach out to{' '}
                <Link
                  ...
                  href="https://t.me/sphynxswapsupportbsc"
                >
                  https://t.me/sphynxswapsupportbsc
                </Link>{' '}
            ...
            <StepWrapper number="10" stepName="Finalize" step={step} onClick={() => setStep(10)}>
              <NoteWrapper style={{ maxWidth: 'unset' }}>
                ...
                <FlexWrapper>
                  ...
                  <p className="description">
                    SphynxSwap Rate(Per {nativeCurrency}): {listingRate}
                  </p>
                </FlexWrapper>
                <Sperate />
                <InlineWrapper>
